  ...
  return (
    <div className='w-11/12 text-center mx-auto flex flex-col items-center justify-center gap-4'>
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
          ...
          <a href='/sample-resume.pdf' className='px-8 py-2 border border-gray-500 rounded-full flex items-center gap-2'>Download Resume<Image src={assets.download_icon} alt='dwn-icon' className="rounded-full w-5"/> </a>
